...
class nipt(object):
	...
	def setdir(self):
		...
		a = [input_file,bam_file,sort_bam_file,sort_bam_file_1,rmdup_sort_bam_file,counts_file,unmapped_bam_file,remap_bam_file,micro_sam_file]
		return a
	...
	def mapping(self,zuse = 0):
		...
		#p = subprocess.Popen(["subread-align -t 1 -T 40 -M 0 -I 0 -i ./fa/tox/tox -r"+a[0]+" -o"+a[1]],shell=True) #mapping
		if zuse == 1:
			p.wait()
		return 
